...
+ (void)POSTWithParameters:(NSDictionary*)customParams requestID:(NSNumber *)requestID requestcode:(NSString *)requestcode success:(SuccessCallBack)success failure:(FailureCallBack)fail
{
    ...
    //加密类型，暂分为图片和其他
    NSArray *codingImageArr = @[kRequestCodeuploadgenimg,kRequestCodeUploadCefm,kRequestCodeuploadgenan,kRequestCodeuploadgentt];
...
+ (void)POSTWithParametersContainArr:(NSDictionary *)customParams requestID:(NSNumber *)requestID requestcode:(NSString *)requestcode success:(SuccessCallBack)success failure:(FailureCallBack)fail{
    ...
    //NSLog(@"md5beforeStr--%@", md5checkStr);
    NSString *md5checkStr1 = [md5checkStr stringByReplacingOccurrencesOfString:@"\\" withString:@""];
    NSString *md5checkStr2 = [md5checkStr1 stringByReplacingOccurrencesOfString:@"\n" withString:@""];
    NSString *md5checkStr3 = [md5checkStr2 stringByReplacingOccurrencesOfString:@"\t" withString:@""];
    NSString *md5check = [NSString md5Str:md5checkStr3];
